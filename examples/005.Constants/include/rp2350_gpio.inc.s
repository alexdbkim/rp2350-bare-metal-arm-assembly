...
@   Date    : June 5, 2025
@
@   RP2350 GPIO (Genral Purpose I/O) (9.)
@
@==============================================================================

@ [IO User Bank]
@ The User Bank IO registers start at a base address of IO_BANK0_BASE (0x40028000)
...
@ [Pad Control]
@ The User Bank Pad Control registers start at a base address of PADS_BANK0_BASE (0x40038000)
